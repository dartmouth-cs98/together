...
switch(page) {
	...
	case 6:
		...
		draw_rectangle(global.cam_width/2 - 1, global.cam_height/2 - 53, global.cam_width/2 + 50, global.cam_height/2 - 5, false);
	...
	case 7:
		draw_text(global.cam_width/2, 150, "Thats It! Please Enjoy!");
		break;
